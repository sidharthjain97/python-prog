...
class DomainIdentification():
    ...
    def main(self):
        ...
        # head = [x for x in range(1,31,1)]
        # print(head)
        # df1 = pd.DataFrame(self.distance_matrix, columns=head)
        # df1.to_excel('distance_30.xlsx', index=False)
        ...
        # while(count):
            ...
            print("removing not connected nodes")
            for node in self.nodes.keys():
            ...
            print("correcting domain initials")
